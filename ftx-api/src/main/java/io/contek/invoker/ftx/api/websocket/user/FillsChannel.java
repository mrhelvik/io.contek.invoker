...
@ThreadSafe
public final class FillsChannel extends WebSocketChannel<FillsChannel.Id, FillsChannel.Message> {
  ...
  @Immutable
  public static final class Id extends WebSocketChannelId<FillsChannel.Message> {
